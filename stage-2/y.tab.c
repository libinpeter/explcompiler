...
static const char *const yytname[] =
{
  ...
  "BEG", "READ", "WRITE", "END", "ASGN", "ID", "';'", "'('", "')'",
  "$accept", "start", "slist", "exp", "stmt", YY_NULLPTR
};
#endif
...
{
      17,    20,     5,     9,    12,   -13,    27,    25,   -13,   -13,
      24,    13,    13,    26,   -13,    28,   -13,   -13,    13,     3,
      -3,   -13,    29,    16,    13,    13,    13,    13,    31,   -13,
     -13,   -13,    11,    11,   -13,   -13,   -13
};
...
{
      20,    24,    25,    26,    27,     9,    23,    24,    25,    26,
      27,    29,    32,    33,    34,    35,    16,    26,    27,    28,
      24,    25,    26,    27,    10,     1,    17,    11,    18,     3,
       4,     5,    31,     6,     3,     4,    13,    15,     6,    12,
      21,    14,     0,    30,    22,    36
};

static const yytype_int8 yycheck[] =
{
      12,     4,     5,     6,     7,     0,    18,     4,     5,     6,
       7,    14,    24,    25,    26,    27,     3,     6,     7,    16,
       4,     5,     6,     7,    15,     8,    13,    15,    15,     9,
      10,    11,    16,    13,     9,    10,    11,    13,    13,    12,
      14,     7,    -1,    14,    16,    14
};
...
{
       0,     8,    18,     9,    10,    11,    13,    19,    21,     0,
      15,    15,    12,    11,    21,    13,     3,    13,    15,    20,
      20,    14,    16,    20,     4,     5,     6,     7,    16,    14,
      14,    16,    20,    20,    20,    20,    14
};
...
#line 1256 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 24 "ast.y" /* yacc.c:1646  */
    {(yyval.no)=Createtree(0,0,NULL,CONN,(yyvsp[-1].no),(yyvsp[0].no));}
...
#line 27 "ast.y" /* yacc.c:1646  */
    {(yyval.no) = Createtree(0,0,'+',EXPR,(yyvsp[-2].no),(yyvsp[0].no));}
...
#line 37 "ast.y" /* yacc.c:1646  */
    {(yyval.no) = Createtree(0,0,'=',ASSN,(yyvsp[-3].no),(yyvsp[-1].no));}
#line 1316 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 38 "ast.y" /* yacc.c:1646  */
    {(yyval.no) = Createtree(0,0,NULL,RD,(yyvsp[-2].no),NULL);}
#line 1322 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 39 "ast.y" /* yacc.c:1646  */
    {(yyval.no) = Createtree(0,0,NULL,WT,(yyvsp[-2].no),NULL);}
